...
namespace BugTracker.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ChangeDisplayName(ChangeDisplayNameViewModel model)
        {
            ...
            //db.Users.Attach(model.NewDisplayName );
            ...
            db.Users.Find(User.Identity.GetUserId()).DisplayName = model.NewDisplayName;
            var DisplayName = model.NewDisplayName;
            //db.Entry(DisplayName).Property().IsModified = true;
            db.SaveChanges();
        ...
        //        return View(model);
        //    }
        //    var result = await UserManager.ChangePasswordAsync(User.Identity.GetUserId(), model.OldDisplayName, model.NewDisplayName);
        //    if (result.Succeeded)
        //    {
        //        var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
        //        if (user != null)
